...
type Keeper interface {
	...
	UpdateCredentials(ctx context.Context, creds *entity.Credentials, overwrite bool) error
	...
	UpdateCard(ctx context.Context, card *entity.Card, overwrite bool) error
	...
	UpdateTextNote(ctx context.Context, note *entity.TextNote, overwrite bool) error
	...
	UpdateRawNote(ctx context.Context, note *entity.RawNote, overwrite bool) error
